...
function ModalCrudEdit({ isOpen, onClose, selectedPostIndex, filteredPosts }) {
    ...
    useEffect(() => {
      if (selectedPostIndex !== null && filteredPosts && filteredPosts.length > 0 && selectedPostIndex < filteredPosts.length) {
    ...
    const handleEditSubmit = async (e) => {
        ...
        try {
          ...
          // Adicione a lógica para obter o ID do post a ser atualizado (se necessário)
          // const postId = ...;
